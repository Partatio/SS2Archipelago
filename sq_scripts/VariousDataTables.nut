...
mapinstructions =
{
    ...
    "medsci1.mis": [
        ...
        ["placeaploc", "KeepDuplicates", [1095], 17, 38], #17:In body near medical entrance 2 medsci1
        ...
        ["placeaploc", "KeepDuplicates", vector(77.62, -93.63, -2.78), 22, 2005], #22:Directly after airlock to the left above on beam 2 medsci1
        ...
        ["placeaploc", "KeepDuplicates", [833], 25, 1340], #25:In body in corridor in R&D 2 medsci1
        ...
        ["placeaploc", "KeepDuplicates", vector(-11.85, 109.56, -8.42), 29, 253], #29:On counter near sink in R&D 2 medsci1
        ["destroy", "RemoveDuplicates", 253],
        ["placeaploc", "", [525, 533, 1391, 562], 30, 719], #30:In container in R&D medsci1
        ["placeaploc", "KeepDuplicates", [525, 533, 1391, 562], 31, 1341], #31:In container in R&D 2 medsci1
        ...
        ["placeaploc", "KeepDuplicates", vector(-60.32, -194.77, 0.1), 38, 270], #38:On desk near medical entrance 2 medsci1
        ...
        ["placeaploc", "KeepDuplicates", [828, 798, 794], 40, 160], #40:In body bags near Quantum Bio-Reconstruction Machine 2 medsci1
        ...
        ["placeaploc", "KeepDuplicates", [467], 47, 362], #47:In security crate in surveillance room that the first enemy runs out of 2 medsci1
        ...
        ["placeaploc", "KeepDuplicates", vector(42.46, -162.98, 3.97), 51, 599], #51:Behind Glass in area after airlock 2 medsci1
        ...
        ["placeaploc", "KeepDuplicates", vector(25.65, -176.69, -15.32), 58, 1180], #58:In hackable closet in area after airlock 2 medsci1
        ["destroy", "RemoveDuplicates", 1180],
        ["placeaploc", "KeepDuplicates", vector(29.18, -176.85, -15.32), 59, 1176], #59:In hackable closet in area after airlock 3 medsci1
        ...
        ["placeaploc", "KeepDuplicates", [915, 1071, 483, 976], 62, 1073], #62:In desk in room in hallway where someone runs towards R&D 2 medsci1
        ["destroy", "RemoveDuplicates", 1073],
        ["placeaploc", "KeepDuplicates", [915, 1071, 483, 976], 63, 1075], #63:In desk in room in hallway where someone runs towards R&D 3 medsci1
        ["destroy", "RemoveDuplicates", 1075],
        ["placeaploc", "KeepDuplicates", [915, 1071, 483, 976], 64, 1078], #64:In desk in room in hallway where someone runs towards R&D 4 medsci1
        ...
        ["placeaploc", "KeepDuplicates", [474], 66, 1100], #66:In security crate in room in hallway where someone runs towards R&D 2 medsci1
        ["destroy", "RemoveDuplicates", 1100],
        ["placeaploc", "KeepDuplicates", [474], 67, 475], #67:In security crate in room in hallway where someone runs towards R&D 3 medsci1
        ...
        ["placeaploc", "KeepDuplicates", [471], 70, 1033], #70:In security crate in lower area with explosives directly outside R&D 2 medsci1
        ["destroy", "RemoveDuplicates", 1033],
        ["placeaploc", "", [734], 71, 252], #71:In Dr Watts in R&D medsci1
        ["placeaploc", "KeepDuplicates", [734], 72, 251], #72:In Dr Watts in R&D 2 medsci1
        ...
        ["placeaploc", "KeepDuplicates", [1182], 75, 1006], #75:In body near charger near chem storage room 2 medsci1
        ...
        ["placeaploc", "KeepDuplicates", vector(-40.92, -5.91, 5), 81, 478], #81:Above on pipe near turret near crew quarters entrance 2 medsci1
        ...
        ["placeaploc", "KeepDuplicates", [1362], 102, 2169], #102:In body in closet in R&D 2 medsci1
    ...
    "medsci2.mis": [
        ...
        ["placeaploc", "KeepDuplicates", vector(-36.35, -56.52, -1.22), 106, 1377], #106:On bench in armory near entrance 2 medsci2crew
        ...
        ["placeaploc", "KeepDuplicates", [417], 114, 191], #114:In desk in flooded room underneath camera medsci2crew
        ...
        ["placeaploc", "KeepDuplicates", [641], 118, 637], #118:In body in maintenance alcove above room accross from Watts room in flooded area medsci2crew
        ...
        ["placeaploc", "KeepDuplicates", vector(-87.61, 21.94, 3.98), 127, 1838], #127:Behind forcefield in wall cutout in room in walkway above flooded hallway 2 medsci2crew
        ...
        ["placeaploc", "KeepDuplicates", [595, 604], 130, 601], #130:In crates in armory near entrance 2 medsci2crew
        ["destroy", "RemoveDuplicates", 601],
        ["placeaploc", "KeepDuplicates", [595, 604], 131, 593], #131:In crates in armory near entrance 3 medsci2crew
        ["destroy", "RemoveDuplicates", 593],
        ["placeaploc", "KeepDuplicates", [595, 604], 132, 596], #132:In crates in armory near entrance 4 medsci2crew
        ["destroy", "RemoveDuplicates", 596],
        ["placeaploc", "KeepDuplicates", [595, 604], 133, 598], #133:In crates in armory near entrance 5 medsci2crew
        ["destroy", "RemoveDuplicates", 598],
        ["placeaploc", "KeepDuplicates", vector(-49.85, -70.76, -1.6), 134, 1379], #134:On ground in armory near entrance 2 medsci2crew
        ["destroy", "RemoveDuplicates", 1379],
        ["placeaploc", "KeepDuplicates", [503], 135, 772], #135:In desk in Watts room 2 medsci2crew
        ...
        ["randomizeenemy", "", 705, "1", vector(-126.7, -62.23, -0.05)],
        ...
        ["placeaploc", "KeepDuplicates", [1189], 146, 429], #146:In desk in recovery upper level medsci2med
        ["destroy", "RemoveDuplicates", 429],
        ["placeaploc", "KeepDuplicates", [1189], 147, 215], #147:In desk in recovery upper level 2 medsci2med
        ...
        ["placeaploc", "KeepDuplicates", [666], 150, 700], #150:In body in recovery room with monkeys on lower floor 2 medsci2med
        ...
        ["placeaploc", "KeepDuplicates", [664, 678], 154, 1285], #154:In crates in recovery lower area 2 medsci2med
        ...
        ["placeaploc", "KeepDuplicates", [211, 339, 1225], 156, 1034], #156:In crates or corpse in radiated area with radiation barrel 2 medsci2med
        ["destroy", "RemoveDuplicates", 1034],
        ["placeaploc", "KeepDuplicates", [211, 339, 1225], 157, 1451], #157:In crates or corpse in radiated area with radiation barrel 3 medsci2med
        ...
        ["placeaploc", "KeepDuplicates", vector(-37.13, -247.16, 0.16), 159, 1495], #159:On counter near sink in radiated area with radiation barrel 2 medsci2med
        ...
        ["placeaploc", "KeepDuplicates", [137], 162, 139], #162:In security crate in radiated icu area 2 medsci2med
        ["destroy", "RemoveDuplicates", 139],
        ["placeaploc", "KeepDuplicates", [137], 163, 200], #163:In security crate in radiated icu area 3 medsci2med
        ...
        ["placeaploc", "KeepDuplicates", vector(31.52, -256.68, -13.19), 168, 327], #168:On counter on bottom level in 3 level room near biopsy sign 2 medsci2med
        ...
        ["placeaploc", "KeepDuplicates", [635, 465], 170, 190], #170:In crates on top level in 3 level room near biopsy sign 2 medsci2med
        ["destroy", "RemoveDuplicates", 190],
        ["placeaploc", "KeepDuplicates", [135], 171, 362], #171:In security crate on top level in 3 level room near biopsy sign 2 medsci2med
        ["destroy", "RemoveDuplicates", 362],
        ["placeaploc", "", [1475, 1476], 172, 498], #172:In body or crate in closet near biopsy sign medsci2med
        ["placeaploc", "KeepDuplicates", [1475, 1476], 173, 206], #173:In body or crate in closet near biopsy sign 2 medsci2med
        ["destroy", "RemoveDuplicates", 206],
        ["placeaploc", "KeepDuplicates", [1475, 1476], 174, 1201], #174:In body or crate in closet near biopsy sign 3 medsci2med
        ["destroy", "RemoveDuplicates", 1201],
        ["placeaploc", "KeepDuplicates", [105], 175, 1904], #175:In body on bottom level in 3 level room near biopsy sign 2 medsci2med
    ...
    "eng1.mis": [
        ...
        ["placeaploc", "KeepDuplicates", vector(92.63, -36.1, -58.78), 179, 1570], #179:In tunnel in stbd nacelle near engine core eng1
        ["destroy", "RemoveDuplicates", 1570],
        ["placeaploc", "", [1158], 180, 1276], #180:In crate in tunnel in stbd nacelle near engine core eng1
        ["placeaploc", "KeepDuplicates", [1158], 181, 303], #181:In crate in tunnel in stbd nacelle near engine core 2 eng1
        ["destroy", "RemoveDuplicates", 303],
        ["placeaploc", "KeepDuplicates", [1158], 182, 1587], #182:In crate in tunnel in stbd nacelle near engine core 3 eng1
        ...
        ["placeaploc", "KeepDuplicates", [1499, 1507, 1552, 1551], 186, 1567], #186:In crates or body crushed by pipe in open room with keypad eng1
        ["destroy", "RemoveDuplicates", 1567],
        ["placeaploc", "KeepDuplicates", [1499, 1507, 1552, 1551], 187, 1179], #187:In crates or body crushed by pipe in open room with keypad 2 eng1
        ...
        ["placeaploc", "KeepDuplicates", [1203], 195, 1206], #195:In body in recessed area behind engine core 2 eng1
        ...
        ["placeaploc", "KeepDuplicates", [1515], 199, 831], #199:In body in stbd nacelle near outer back of tunnel eng1
        ...
        ["placeaploc", "KeepDuplicates", [545], 202, 491], #202:In desk directly next to entrance 2 eng1
        ["destroy", "RemoveDuplicates", 491],
        ["placeaploc", "KeepDuplicates", [545], 203, 1398], #203:In desk directly next to entrance 3 eng1
        ["destroy", "RemoveDuplicates", 1398],
        ["placeaploc", "KeepDuplicates", [545], 204, 1318], #204:In desk directly next to entrance 4 eng1
        ...
        ["placeaploc", "KeepDuplicates", [1063], 206, 1277], #206:In body in radiated hallways along shuttle bay arrows eng1
        ...
        ["placeaploc", "KeepDuplicates", [69], 212, 1494], #212:In desk in office near engine core computer 2 eng1
        ["destroy", "RemoveDuplicates", 1494],
        ["placeaploc", "", [851], 213, 1303], #213:In security crate in lower walkway next to elevator eng1
        ["placeaploc", "KeepDuplicates", [851], 214, 1160], #214:In security crate in lower walkway next to elevator 2 eng1
        ...
        ["placeaploc", "KeepDuplicates", [823], 218, 1116], #218:In security crate in radiated hallways along engine core signs 2 eng1
        ["destroy", "RemoveDuplicates", 1116],
        ["placeaploc", "", [906, 1180, 1159], 219, 1167], #219:In bodies in lower walkway eng1
        ["placeaploc", "KeepDuplicates", [906, 1180, 1159], 220, 1079], #220:In bodies in lower walkway 2 eng1
        ["destroy", "RemoveDuplicates", 1079],
        ["placeaploc", "KeepDuplicates", [906, 1180, 1159], 221, 1434], #221:In bodies in lower walkway 3 eng1
        ["destroy", "RemoveDuplicates", 1434],
        ["placeaploc", "KeepDuplicates", [906, 1180, 1159], 222, 913], #222:In bodies in lower walkway 4 eng1
        ["destroy", "RemoveDuplicates", 913],
        ["placeaploc", "KeepDuplicates", [906, 1180, 1159], 223, 909], #223:In bodies in lower walkway 5 eng1
        ["destroy", "RemoveDuplicates", 909],
        ["placeaploc", "KeepDuplicates", [836, 855], 224, 866], #224:In enemies in lower walkway 2 eng1
        ["destroy", "RemoveDuplicates", 866],
        ["placeaploc", "", [1011], 225, 820], #225:In desk in room connected to chemical storage eng1
        ["placeaploc", "KeepDuplicates", [1011], 226, 1321], #226:In desk in room connected to chemical storage 2 eng1
        ...
        ["placeaploc", "KeepDuplicates", [819], 247, 821], #247:In body outside chemical storage 2 eng1
        ...
        ["placeaploc", "KeepDuplicates", [1438, 1440, 1439, 1420, 1422], 253, 1452], #253:In crates in aux storage 2 eng1
        ["destroy", "RemoveDuplicates", 1452],
        ["placeaploc", "KeepDuplicates", [1438, 1440, 1439, 1420, 1422], 254, 1460], #254:In crates in aux storage 3 eng1
        ["destroy", "RemoveDuplicates", 1460],
        ["placeaploc", "KeepDuplicates", [1438, 1440, 1439, 1420, 1422], 255, 1459], #255:In crates in aux storage 4 eng1
        ["destroy", "RemoveDuplicates", 1459],
        ["placeaploc", "KeepDuplicates", [1438, 1440, 1439, 1420, 1422], 256, 1466], #256:In crates in aux storage 5 eng1
        ...
        ["placeaploc", "KeepDuplicates", [874], 259, 1161], #259:In body in bottom of central room near elevator 2 eng1
        ...
        ["placeaploc", "KeepDuplicates", [1667], 267, 1634], #267:In body near engineering control grav shaft 2 eng1
        ...
        ["placeaploc", "KeepDuplicates", [1801, 1643], 269, 1648], #269:In bodies in room after engineering control grav shaft 2 eng1
        ["destroy", "RemoveDuplicates", 1648],
        ["placeaploc", "KeepDuplicates", [1801, 1643], 270, 188], #270:In bodies in room after engineering control grav shaft 3 eng1
        ["destroy", "RemoveDuplicates", 188],
        ["placeaploc", "KeepDuplicates", vector(-1.96, -417.3, -5.92), 271, 451], #271:On ground outside fluidics controls room near engineering control gravshafts 2 eng1
        ...
        ["placeaploc", "KeepDuplicates", [1042, 894, 854], 278, 190], #278:In body or lockers in security office after engineering control grav shaft 4 eng1
        ["destroy", "RemoveDuplicates", 190],
        ...
        ["placeaploc", "KeepDuplicates", [1331], 281, 901], #281:In body outside security office after engineering control grav shaft 2 eng1
    ...
    "eng2.mis": [
        ...
        ["placeaploc", "KeepDuplicates", [507, 508], 289, 1426], #289:In bodies on 3rd floor in cargo bay 2b 2 eng2
        ["destroy", "RemoveDuplicates", 1426],
        ["placeaploc", "KeepDuplicates", [507, 508], 290, 220], #290:In bodies on 3rd floor in cargo bay 2b 3 eng2
        ...
        ["placeaploc", "KeepDuplicates", [233], 293, 938], #293:In body in cargo bay 1a 2 eng2
        ...
        ["placeaploc", "KeepDuplicates", [655], 298, 657], #298:In body along main hallway before room with 4 doors 2 eng2
        ["destroy", "RemoveDuplicates", 657],
        ["placeaploc", "", [44, 64], 299, 930], #299:In bodies in command control eng2
        ["placeaploc", "KeepDuplicates", [44, 64], 300, 917], #300:In bodies in command control 2 eng2
        ...
        ["placeaploc", "KeepDuplicates", [1676], 304, 1682], #304:In crate in lower area under removed flooring panel in shuttle bay 2 eng2
        ...
        ["placeaploc", "KeepDuplicates", [1029, 1032, 1030, 176, 83, 84, 953, 136, 87, 126], 306, 1169], #306:In crates in shuttle bay 2 eng2
        ["destroy", "RemoveDuplicates", 1169],
        ["placeaploc", "KeepDuplicates", [1029, 1032, 1030, 176, 83, 84, 953, 136, 87, 126], 307, 1168], #307:In crates in shuttle bay 3 eng2
        ["destroy", "RemoveDuplicates", 1168],
        ["placeaploc", "KeepDuplicates", [1029, 1032, 1030, 176, 83, 84, 953, 136, 87, 126], 308, 1170], #308:In crates in shuttle bay 4 eng2
        ["destroy", "RemoveDuplicates", 1170],
        ["placeaploc", "KeepDuplicates", [1029, 1032, 1030, 176, 83, 84, 953, 136, 87, 126], 309, 602], #309:In crates in shuttle bay 5 eng2
        ["destroy", "RemoveDuplicates", 602],
        ["placeaploc", "KeepDuplicates", [923], 310, 936], #310:In body on 2nd floor in cargo bay 1a eng2
        ["destroy", "RemoveDuplicates", 936],
        ["placeaploc", "KeepDuplicates", [923], 311, 987], #311:In body on 2nd floor in cargo bay 1a 2 eng2
        ["destroy", "RemoveDuplicates", 987],
        ["placeaploc", "KeepDuplicates", [352], 312, 373], #312:In body on 3rd floor in cargo bay 1a eng2
        ...
        ["placeaploc", "KeepDuplicates", vector(82.44, -606.23, -22.6), 314, 846], #314:On boxes behind droid containers in cargo bay 1a 2 eng2
        ["destroy", "RemoveDuplicates", 846],
        ["placeaploc", "KeepDuplicates", vector(84.66, -606.32, -22.6), 315, 988], #315:On boxes behind droid containers in cargo bay 1a 3 eng2
        ...
        ["placeaploc", "KeepDuplicates", vector(73.48, -686.61, -4.32), 319, 922], #319:On top of boxes near 2 droid containers on second floor in cargo bay 1a 2 eng2
        ...
        ["placeaploc", "KeepDuplicates", [168], 322, 169], #322:In security crate on third floor in cargo bay 1a 2 eng2
        ["destroy", "RemoveDuplicates", 169],
        ["placeaploc", "KeepDuplicates", [168], 323, 347], #323:In security crate on third floor in cargo bay 1a 3 eng2
        ...
        ["placeaploc", "KeepDuplicates", [205], 327, 228], #327:In security crate in cargo bay 1b 2 eng2
        ...
        ["placeaploc", "KeepDuplicates", [1531, 360], 329, 931], #329:In bodies on 3rd floor in cargo bay 1b 2 eng2
        ["destroy", "RemoveDuplicates", 931],
        ["placeaploc", "", [21], 330, 658], #330:In body near security control station in cargo bay 1b eng2
        ["placeaploc", "KeepDuplicates", [21], 331, 659], #331:In body near security control station in cargo bay 1b 2 eng2
        ...
        ["placeaploc", "KeepDuplicates", [31], 334, 32], #334:In desk near security control station in cargo bay 1b 2 eng2
        ...
        ["placeaploc", "KeepDuplicates", [24], 337, 924], #337:In body on 2nd floor in cargo bay 1b 2 eng2
        ["destroy", "RemoveDuplicates", 924],
        ["placeaploc", "", vector(83.42, -411.16, -20.97), 338, 317], #338:On top of boxes in cargo bay 1b eng2
        ["placeaploc", "KeepDuplicates", vector(100.56, -392.74, -22), 339, 939], #339:On top of boxes in cargo bay 1b 2 eng2
        ["destroy", "RemoveDuplicates", 939],
        ["placeaploc", "", [1357], 340, 928], #340:In body on 3rd floor in cargo bay 1b eng2
        ["placeaploc", "KeepDuplicates", [1357], 341, 984], #341:In body on 3rd floor in cargo bay 1b 2 eng2
        ...
        ["placeaploc", "KeepDuplicates", [390], 344, 392], #344:In body in cargo bay 2a 2 eng2
        ["destroy", "RemoveDuplicates", 392],
        ["placeaploc", "", [45], 345, 921], #345:In body near hygenic storage sign in cargo bay 2a
        ["placeaploc", "KeepDuplicates", [45], 346, 49], #346:In body near hygenic storage sign in cargo bay 2 2a
        ["destroy", "RemoveDuplicates", 49],
        ["placeaploc", "KeepDuplicates", [45], 347, 48], #347:In body near hygenic storage sign in cargo bay 3 2a
        ...
        ["placeaploc", "KeepDuplicates", [67], 350, 985], #350:In headless body in cargo bay 2a eng2
        ...
        ["placeaploc", "KeepDuplicates", [339], 353, 343], #353:In security crate on 3rd floor in cargo bay 2a 2 eng2
        ...
        ["placeaploc", "KeepDuplicates", [428], 358, 950], #358:In security crate on 3rd floor in cargo bay 2b 2 eng2
        ["destroy", "RemoveDuplicates", 950],
        ["placeaploc", "", [906], 359, 909], #359:In desk in cargo bay 2b eng2
        ["placeaploc", "KeepDuplicates", [906], 360, 926], #360:In desk in cargo bay 2b 2 eng2
        ...
        ["placeaploc", "KeepDuplicates", [413], 364, 983], #364:In body on 2nd floor in cargo bay 2b 2 eng2
        ...
        ["randomizeenemy", "", 808, "2", vector(12.03, -724.84, -29.15)],
        ["randomizeenemy", "", 854, "2", vector(31.85, -717.96, -31.05)],
        ["randomizeenemy", "", 660, "2", vector(79.59, -696.32, 7.85)],
        ["randomizeenemy", "", 528, "2", vector(74.21, -615.15, -27.52)],
        ["randomizeenemy", "", 267, "2", vector(83.64, -539.52, 7.03)],
        ["randomizeenemy", "", 240, "2", vector(105.37, -521.16, -28.97)],
        ["randomizeenemy", "", 259, "2", vector(81.17, -508.57, -6.97)],
        ["randomizeenemy", "", 140, "2", vector(54.32, -466.46, -25.47)],
        ["randomizeenemy", "", 300, "2", vector(80.89, -418.62, 7.03)],
        ["randomizeenemy", "", 294, "2", vector(92.54, -419.9, -9.69)],
        ["randomizeenemy", "", 308, "2", vector(86.28, -418.16, -28.97)],
        ["randomizeenemy", "", 249, "2", vector(108.29, -433.01, -29.97)],
        ["randomizeenemy", "", 553, "2", vector(-68.31, -398.24, 8.18)],
        ["randomizeenemy", "", 492, "2", vector(-60.61, -434.26, -24.84)],
        ["randomizeenemy", "", 431, "2", vector(-55.75, -481, -29.02)],
        ["randomizeenemy", "", 70, "2", vector(-82.82, -510.44, -27.05)],
        ["randomizeenemy", "", 386, "2", vector(-105.79, -575.89, 10.83)],
        ["randomizeenemy", "", 388, "2", vector(-86.64, -595.38, -26.05)],
        ["randomizeenemy", "", 427, "2", vector(-106.48, -662.88, -28.97)],
        ["randomizeenemy", "", 50, "2", vector(-77.13, -675.99, -9.05)],
        ["randomizeenemy", "", 376, "2", vector(-60.67, -691.69, 8.95)],
    ],
    "hydro2.mis": [
        ...
        ["placeaploc", "KeepDuplicates", vector(-75.62, -34.15, -4.22), 370, 1038], #370:On ground behind sector b door 3 hydro2
        ...
        ["placeaploc", "KeepDuplicates", [483, 629, 619, 695], 378, 862], #378:In bodies/desks in room in research area 2 hydro2
        ["destroy", "RemoveDuplicates", 862],
        ["placeaploc", "KeepDuplicates", [483, 629, 619, 695], 379, 1586], #379:In bodies/desks in room in research area 3 hydro2
        ["destroy", "RemoveDuplicates", 1586],
        ["placeaploc", "KeepDuplicates", [483, 629, 619, 695], 380, 978], #380:In bodies/desks in room in research area 4 hydro2
        ["destroy", "RemoveDuplicates", 978],
        ["placeaploc", "", [744], 381, 2183], #381:In desk in room in research area hydro2
        ["placeaploc", "KeepDuplicates", [744], 382, 2184], #382:In desk in room in research area 2 hydro2
        ["destroy", "RemoveDuplicates", 2184],
        ["placeaploc", "KeepDuplicates", vector(-14.99, 80.27, -4.78), 383, 1063], #383:On ground under desk in room in research area hydro2
        ...
        ["placeaploc", "KeepDuplicates", [713, 675], 385, 1185], #385:In desks in room connected to room with broken replicator 2 hydro2
        ...
        ["placeaploc", "KeepDuplicates", vector(-63.95, 89.69, -1.62), 387, 1064], #387:On desk in room connected to room with broken replicator 2 hydro2
        ["destroy", "RemoveDuplicates", 1064],
        ["placeaploc", "KeepDuplicates", [311, 210, 138, 139, 143, 1215, 1230, 1229], 388, 1065], #388:In desks/crates/body in room with charger hydro2
        ["destroy", "RemoveDuplicates", 1065],
        ["placeaploc", "KeepDuplicates", [311, 210, 138, 139, 143, 1215, 1230, 1229], 389, 1019], #389:In desks/crates/body in room with charger 2 hydro2
        ["destroy", "RemoveDuplicates", 1019],
        ["placeaploc", "KeepDuplicates", [311, 210, 138, 139, 143, 1215, 1230, 1229], 390, 1016], #390:In desks/crates/body in room with charger 3 hydro2
        ["destroy", "RemoveDuplicates", 1016],
        ["placeaploc", "KeepDuplicates", [311, 210, 138, 139, 143, 1215, 1230, 1229], 391, 1017], #391:In desks/crates/body in room with charger 4 hydro2
        ...
        ["placeaploc", "KeepDuplicates", [355], 395, 485], #395:In body next to pipes in room with xerxes 2 hydro2
        ...
        ["placeaploc", "KeepDuplicates", vector(-76.5, 39.5, 8.3), 398, 1048], #398:On ground in ceiling connected through vent to room with glass floors 2 hydro2
        ["destroy", "RemoveDuplicates", 1048],
        ["placeaploc", "", [598], 399, 1024], #399:In desk in room at end of hallway in admin area hydro2
        ["placeaploc", "KeepDuplicates", [598], 400, 823], #400:In desk in room at end of hallway in admin area 2 hydro2
        ...
        ["placeaploc", "KeepDuplicates", [751], 404, 1505], #404:In body near sector a 2 hydro2
        ...
        ["placeaploc", "KeepDuplicates", vector(-106.02, 104.17, -4.37), 407, 861], #407:Under bench in white hallway with glass next to sector d 2 hydro2
        ...
        ["placeaploc", "KeepDuplicates", [1413], 413, 1031], #413:In body in room with glass floors 2 hydro2
        ...
        ["placeaploc", "KeepDuplicates", vector(-195, 84, 6.11), 416, 632], #416:On ground near desk and headless body in room above biohazard room with environmental regulator hydro2
        ...
        ["placeaploc", "KeepDuplicates", [1237, 314, 89, 338], 418, 814], #418:In crate/desks/body in room above biohazard room with environmental regulator 2 hydro2
        ...
        ["placeaploc", "KeepDuplicates", [2078, 2143], 421, 1226], #421:In lockers near pool and chemical storeroom 2 hydro2
        ...
        ["placeaploc", "KeepDuplicates", [1294], 425, 677], #425:In body near med beds hydro2
        ["destroy", "RemoveDuplicates", 677],
        ["placeaploc", "KeepDuplicates", [1294], 426, 1040], #426:In body near med beds 2 hydro2
        ["destroy", "RemoveDuplicates", 1040],
        ["placeaploc", "KeepDuplicates", [1294], 427, 1044], #427:In body near med beds 3 hydro2
        ["destroy", "RemoveDuplicates", 1044],
        ["placeaploc", "", vector(-124.38, -72.71, -4.48), 428, 1207], #428:On med bed hydro2
        ["placeaploc", "KeepDuplicates", vector(-124.34, -70.03, -4.48), 429, 2079], #429:On med bed 2 hydro2
        ["destroy", "RemoveDuplicates", 2079],
        ["placeaploc", "KeepDuplicates", vector(-128.67, -73.84, -7.84), 430, 1154], #430:Under med bed hydro2
        ...
        ["placeaploc", "KeepDuplicates", [935, 1298, 1297, 936], 433, 1045], #433:In bodies in snowy area 2 hydro2
        ["destroy", "RemoveDuplicates", 1045],
        ["placeaploc", "KeepDuplicates", [935, 1298, 1297, 936], 434, 824], #434:In bodies in snowy area 3 hydro2
        ["destroy", "RemoveDuplicates", 824],
        ["placeaploc", "KeepDuplicates", [935, 1298, 1297, 936], 435, 185], #435:In bodies in snowy area 4 hydro2
        ["destroy", "RemoveDuplicates", 185],
        ["placeaploc", "KeepDuplicates", [935, 1298, 1297, 936], 436, 1039], #436:In bodies in snowy area 5 hydro2
        ["destroy", "RemoveDuplicates", 1039],
        ["placeaploc", "KeepDuplicates", [935, 1298, 1297, 936], 437, 1329], #437:In bodies in snowy area 6 hydro2
        ["destroy", "RemoveDuplicates", 1329],
        ["placeaploc", "KeepDuplicates", [935, 1298, 1297, 936], 438, 766], #438:In bodies in snowy area 7 hydro2
        ["destroy", "RemoveDuplicates", 766],
        ["placeaploc", "KeepDuplicates", [935, 1298, 1297, 936], 439, 1028], #439:In bodies in snowy area 8 hydro2
        ["destroy", "RemoveDuplicates", 1028],
        ["placeaploc", "KeepDuplicates", [935, 1298, 1297, 936], 440, 1317], #440:In bodies in snowy area 9 hydro2
        ["destroy", "RemoveDuplicates", 1317],
        ["placeaploc", "", [1705], 441, 2019], #441:In enemy above snowy area hydro2
        ["placeaploc", "KeepDuplicates", [935, 1298, 1297, 936], 442, 1315], #442:In bodies in snowy area 10 hydro2
        ["destroy", "RemoveDuplicates", 1315],
        ["placeaploc", "KeepDuplicates", [935, 1298, 1297, 936], 443, 762], #443:In bodies in snowy area 11 hydro2
        ...
        ["placeaploc", "KeepDuplicates", [354, 325], 447, 1186], #447:In desks in chemical storeroom 3 hydro2
        ...
        ["placeaploc", "KeepDuplicates", vector(-148.49, -131.81, -1.32), 455, 1377], #455:On chemical storeroom shelves 5 hydro2
        ["destroy", "RemoveDuplicates", 1377],
    ...
    "hydro1.mis": [
        ...
        ["placeaploc", "KeepDuplicates", vector(-72.82, 60.27, -0.74), 478, 545], #478:Under bench near security control station in hallways near entrance hydro1
        ...
        ["placeaploc", "KeepDuplicates", [466, 465], 484, 998], #484:In bodies near entrance 2 hydro1
        ["destroy", "RemoveDuplicates", 998],
        ["placeaploc", "KeepDuplicates", [466, 465], 485, 1079], #485:In bodies near entrance 3 hydro1
        ["destroy", "RemoveDuplicates", 1079],
        ...
        ["placeaploc", "KeepDuplicates", [1245, 1241], 488, 1069], #488:In crates next to security crate in hallway near entrance 2 hydro1
        ...
        ["placeaploc", "KeepDuplicates", [1003], 491, 996], #491:In enemy in entrance room that spawns after inserting toxin-a in this level 2 hydro1
        ...
        ["placeaploc", "KeepDuplicates", [1248, 1247, 1246, 1250, 1249, 1251], 496, 1032], #496:In crates in storage room 2 hydro1
        ...
        ["placeaploc", "KeepDuplicates", [473, 482], 500, 478], #500:In bodies near security control station in hallways near entrance 2 hydro1
        ["destroy", "RemoveDuplicates", 478],
        ["placeaploc", "KeepDuplicates", [473, 482], 501, 993], #501:In bodies near security control station in hallways near entrance 3 hydro1
        ["destroy", "RemoveDuplicates", 993],
        ["placeaploc", "KeepDuplicates", [473, 482], 502, 1105], #502:In bodies near security control station in hallways near entrance 4 hydro1
        ["destroy", "RemoveDuplicates", 1105],
        ["placeaploc", "KeepDuplicates", vector(-37.92, 49.99, 2.14), 503, 1082], #503:In between plants in hallways near entrance 2 hydro1
        ["destroy", "RemoveDuplicates", 1082],
        ["placeaploc", "KeepDuplicates", [471], 504, 79], #504:In body near door in hallways near entrance hydro1
        ["destroy", "RemoveDuplicates", 79],
        ["placeaploc", "KeepDuplicates", [471], 505, 1090], #505:In body near door in hallways near entrance 2 hydro1
        ["destroy", "RemoveDuplicates", 1090],
        ["placeaploc", "KeepDuplicates", [471], 506, 1000], #506:In body near door in hallways near entrance 3 hydro1
        ["destroy", "RemoveDuplicates", 1000],
        ["placeaploc", "KeepDuplicates", [471], 507, 975], #507:In body near door in hallways near entrance 4 hydro1
        ["destroy", "RemoveDuplicates", 975],
        ["placeaploc", "KeepDuplicates", [472], 508, 1020], #508:In body in hallway between hallways near entrance and cultivation 2 hydro1
        ...
        ["placeaploc", "KeepDuplicates", [1146, 1147], 513, 1145], #513:In crates in second right room in cultivation 2 hydro1
        ["destroy", "RemoveDuplicates", 1145],
        ["placeaploc", "KeepDuplicates", vector(-96.41, -108.55, 10.68), 514, 1144], #514:On ledge near plants up ladder in second right room in cultivation hydro1
        ...
        ["placeaploc", "KeepDuplicates", vector(-48, -88, 7.39), 517, 1055], #517:On ground up ladder in second left room in cultivation 2 hydro1
        ...
        ["placeaploc", "KeepDuplicates", vector(-23.46, -99.89, -4.74), 519, 1141], #519:On ground in water in second left room in cultivation 2 hydro1
    ...
    "hydro3.mis": [
        ...
        ["placeaploc", "KeepDuplicates", vector(-129.37, -77.37, -10.84), 523, 261], #523:On ground near body near environmental regulator 2 hydro3
        ["destroy", "RemoveDuplicates", 261],
        ["placeaploc", "", [192, 207], 524, 95], #524:In bodies near environmental regulator hydro3
        ["placeaploc", "KeepDuplicates", [192, 207], 525, 108], #525:In bodies near environmental regulator 2 hydro3
        ["destroy", "RemoveDuplicates", 108],
        ["placeaploc", "KeepDuplicates", [192, 207], 526, 121], #526:In bodies near environmental regulator 3 hydro3
        ["destroy", "RemoveDuplicates", 121],
        ["placeaploc", "KeepDuplicates", [192, 207], 527, 114], #527:In bodies near environmental regulator 4 hydro3
        ["destroy", "RemoveDuplicates", 114],
        ["placeaploc", "KeepDuplicates", [192, 207], 528, 94], #528:In bodies near environmental regulator 5 hydro3
        ["destroy", "RemoveDuplicates", 94],
        ["placeaploc", "KeepDuplicates", [192, 207], 529, 271], #529:In bodies near environmental regulator 6 hydro3
        ["destroy", "RemoveDuplicates", 271],
        ["placeaploc", "", [189], 530, 124], #530:In body to the right of bottom of ramp hydro3
        ["placeaploc", "KeepDuplicates", [189], 531, 96], #531:In body to the right of bottom of ramp 2 hydro3
        ["destroy", "RemoveDuplicates", 96],
        ["placeaploc", "KeepDuplicates", [189], 532, 97], #532:In body to the right of bottom of ramp 3 hydro3
        ...
        ["placeaploc", "KeepDuplicates", [2116], 535, 116], #535:In desk near replicator in entrance area 2 hydro3
        ["destroy", "RemoveDuplicates", 116],
        ["placeaploc", "KeepDuplicates", [2116], 536, 200], #536:In desk near replicator in entrance area 3 hydro3
        ["destroy", "RemoveDuplicates", 200],
        ["placeaploc", "KeepDupllicates", vector(-60.28, -42.07, 1.08), 537, 967], #537:On ground to right of entrance hydro3
        ["destroy", "RemoveDuplicates", 967],
        ["placeaploc", "KeepDupllicates", [190], 538, 122], #538:In body near entrance hydro3
        ["destroy", "RemoveDuplicates", 538],
        ["placeaploc", "KeepDuplicates", [190], 539, 100], #539:In body near entrance 2 hydro3
        ["destroy", "RemoveDuplicates", 100],
        ["placeaploc", "KeepDuplicates", [190], 540, 105], #540:In body near entrance 3 hydro3
        ...
        ["placeaploc", "KeepDuplicates", vector(-27.31, 8.53, 5.33), 542, 119], #542:Behind crates in raised room with glass near replicator hydro3
        ...
        ["placeaploc", "KeepDuplicates", vector(-52, 38.5, 15.58), 546, 120], #546:In secret wall cutout accessible by jumping on pipes in room with 3 windows across from entrance 2 hydro3
        ["destroy", "RemoveDuplicates", 120],
        ["placeaploc", "KeepDuplicates", vector(-53.42, 38.65, 15.61), 547, 283], #547:In secret wall cutout accessible by jumping on pipes in room with 3 windows across from entrance 3 hydro3
        ["destroy", "RemoveDuplicates", 283],
        ["placeaploc", "", [191], 548, 130], #548:In body in room with 3 windows across from entrance hydro3
        ["placeaploc", "KeepDuplicates", [191], 549, 104], #549:In body in room with 3 windows across from entrance 2 hydro3
        ["destroy", "RemoveDuplicates", 104],
        ["placeaploc", "KeepDuplicates", [191], 550, 113], #550:In body in room with 3 windows across from entrance 3 hydro3
        ["destroy", "RemoveDuplicates", 113],
        ["placeaploc", "KeepDuplicates", [191], 551, 106], #551:In body in room with 3 windows across from entrance 4 hydro3
    ...
    "ops2.mis": [
        ...
        ["placeaploc", "KeepDuplicates", [507, 503, 504, 505, 506], 556, 509], #556:In crates in room with elevator and xerxes ops2
        ["destroy", "RemoveDuplicates", 509],
        ["placeaploc", "KeepDuplicates", [507, 503, 504, 505, 506], 557, 508], #557:In crates in room with elevator and xerxes 2 ops2
        ...
        ["placeaploc", "KeepDuplicates", vector(-170.52, -6.5, -22.92), 560, 1097], #560:In trap down ladder in room on upper floor close to entrance in system admin area 2 ops2
        ...
        ["placeaploc", "KeepDuplicates", [383], 562, 478], #562:In desk in room closest to entrance to the left in system admin area 2 ops2
        ["destroy", "RemoveDuplicates", 478],
        ...
        ["placeaploc", "KeepDuplicates", [519], 565, 521], #565:In desk in first left room coming from conference room in system admin area 2 ops2
        ...
        ["placeaploc", "KeepDuplicates", [158, 454], 568, 487], #568:In desks in room overlooking conference room in system admin area 2 ops2
        ["destroy", "RemoveDuplicates", 487],
        ["placeaploc", "KeepDuplicates", [483, 756], 569, 485], #569:In desks in first right room coming from conference room in system admin area 2 ops2
        ["destroy", "RemoveDuplicates", 485],
        ["placeaploc", "", vector(-171.11, 60.32, -23.92), 570, 1093], #570:On ground outside entrance to crew quarters ops2
        ["placeaploc", "KeepDuplicates", [672], 571, 1492], #571:In body near entrance to crew quarters ops2
        ...
        ["placeaploc", "KeepDuplicates", [1541], 603, 477], #603:In security crate near chemical storeroom 2 ops2
    ...
    "ops3.mis": [
        ...
        ["placeaploc", "KeepDuplicates", vector(36.23, 132.96, -23.8), 627, 1811], #627:On ground in data storage 2 ops3
        ["destroy", "RemoveDuplicates", 1811],
        ["placeaploc", "KeepDuplicates", vector(36.24, 124.44, -23.82), 628, 775], #628:On ground in data storage 3 ops3
        ...
        ["placeaploc", "KeepDuplicates", [1124, 1136], 637, 787], #637:In bodies in freezer area 2 ops3
        ...
        ["placeaploc", "KeepDuplicates", [718], 647, 720], #647:In body in data storage 2 ops3
        ...
        ["placeaploc", "KeepDuplicates", [1031], 652, 696], #652:In security crate in 1st room on right in power admin near entrance 2 ops3
        ...
        ["placeaploc", "KeepDuplicates", [699, 700], 664, 717], #664:In crates in room near charger 3 ops3
        ...
        ["placeaploc", "KeepDuplicates", [790], 668, 723], #668:In body near charger 2 ops3
        ["destroy", "RemoveDuplicates", 723],
        ["placeaploc", "", [1032], 669, 711], #669:In security crate near charger ops3
        ["placeaploc", "KeepDuplicates", [1032], 670, 1033], #670:In security crate near charger 2 ops3
        ["destroy", "RemoveDuplicates", 1033],
        ...
        ["placeaploc", "KeepDuplicates", [733], 673, 763], #673:In body on ramp near charger 2 ops3
        ["destroy", "RemoveDuplicates", 763],
        ["placeaploc", "", [938], 674, 1017], #674:In body near resurrection station ops3
        ["placeaploc", "KeepDuplicates", [938], 675, 1018], #675:In body near resurrection station 2 ops3
    ...
    "ops4.mis": [
        ...
        ["placeaploc", "KeepDuplicates", [408], 698, 372], #698:In desk in room in area above interpolar sim unit 2 ops4
        ["destroy", "RemoveDuplicates", 372],
        ["placeaploc", "", [286], 699, 412], #699:In enemy released after interpolar sim unit is activated ops4
        ["placeaploc", "KeepDuplicates", [557], 700, 558], #700:In body near interpolar sim unit 2 ops4
        ["destroy", "RemoveDuplicates", 558],
        ["placeaploc", "KeepDuplicates", vector(24.51, -40.81, -39.79), 701, 386], #701:On ground near body near interpolar sim unit 2 ops4
        ["destroy", "RemoveDuplicates", 386],
        ["placeaploc", "KeepDuplicates", [382], 702, 384], #702:In desk in room in area above interpolar sim unit 3 ops4
        ["destroy", "RemoveDuplicates", 384],
        ["placeaploc", "KeepDuplicates", [382], 703, 385], #703:In desk in room in area above interpolar sim unit 4 ops4
        ...
        ["placeaploc", "KeepDuplicates", [326], 706, 728], #706:In body above on raised walkway in fluid ops near entrance 2 ops4
        ...
        ["placeaploc", "KeepDuplicates", [369, 370, 365, 364, 402, 400, 399, 397, 396], 712, 422], #712:In lockers in bunks room next to security control station near armory 2 ops4
        ["destroy", "RemoveDuplicates", 422],
        ["placeaploc", "KeepDuplicates", [369, 370, 365, 364, 402, 400, 399, 397, 396], 713, 464], #713:In lockers in bunks room next to security control station near armory 3 ops4
        ["destroy", "RemoveDuplicates", 464],
        ["placeaploc", "KeepDuplicates", [369, 370, 365, 364, 402, 400, 399, 397, 396], 714, 389], #714:In lockers in bunks room next to security control station near armory 4 ops4
        ["destroy", "RemoveDuplicates", 389],
        ["placeaploc", "KeepDuplicates", [369, 370, 365, 364, 402, 400, 399, 397, 396], 715, 423], #715:In lockers in bunks room next to security control station near armory 5 ops4
        ["destroy", "RemoveDuplicates", 423],
        ["placeaploc", "", [467, 348, 351, 352, 353], 716, 1262], #716:In crates in armory ops4
        ["placeaploc", "KeepDuplicates", [467, 348, 351, 352, 353], 717, 119], #717:In crates in armory 2 ops4
        ["destroy", "RemoveDuplicates", 119],
        ["placeaploc", "KeepDuplicates", [467, 348, 351, 352, 353], 718, 379], #718:In crates in armory 3 ops4
        ...
        ["placeaploc", "KeepDuplicates", [140, 150, 151, 152, 131, 135, 138, 139], 722, 411], #722:In lockers in bunks room near shooting range 2 ops4
        ["destroy", "RemoveDuplicates", 411],
        ["placeaploc", "KeepDuplicates", [140, 150, 151, 152, 131, 135, 138, 139], 723, 362], #723:In lockers in bunks room near shooting range 3 ops4
        ["destroy", "RemoveDuplicates", 362],
        ["placeaploc", "KeepDuplicates", [140, 150, 151, 152, 131, 135, 138, 139], 724, 393], #724:In lockers in bunks room near shooting range 4 ops4
        ...
        ["randomizeenemy", "", 683, "4Ranged", vector(-109, -239.5, -35.8)],
    ...
    "rec1.mis": [
        ...
        ["placeaploc", "KeepDuplicates", [262], 753, 151], #753:In body in secret area connected by vent to upper floor room in crew quarters area 3 rec1
        ["destroy", "RemoveDuplicates", 151],
        ["placeaploc", "KeepDuplicates", [262], 754, 1787], #754:In body in secret area connected by vent to upper floor room in crew quarters area 4 rec1
        ...
        ["placeaploc", "KeepDuplicates", [774, 466], 772, 1516], #772:In bodies near transmitter in athletics area 2 rec1
        ...
        ["placeaploc", "KeepDuplicates", [190], 780, 193], #780:In security crate near mall entrance 2 rec1
        ...
        ["placeaploc", "KeepDuplicates", vector(20.43, -394.24, -9.92), 785, 108], #785:On desk near safe nearish elevator 2 rec1
        ["destroy", "RemoveDuplicates", 108],
        ["placeaploc", "KeepDuplicates", [786], 786, 226], #786:In body in upper floor room in crew quarters area 4 rec1
        ...
        ["placeaploc", "KeepDuplicates", [1999, 2000], 802, 196], #802:In crates in room near garden entrance 2 rec1
        ["destroy", "RemoveDuplicates", 196],
        ["placeaploc", "KeepDuplicates", [1999, 2000], 803, 214], #803:In crates in room near garden entrance 3 rec1
        ["destroy", "RemoveDuplicates", 214],
        ["placeaploc", "", vector(17.7, -266.73, -9.59), 804, 109], #804:On med bed near resurrection station rec1
        ["placeaploc", "KeepDuplicates", [348], 805, 1559], #805:In body near resurrection station 2 rec1
        ["destroy", "RemoveDuplicates", 1559],
        ["placeaploc", "KeepDuplicates", [523], 806, 830], #806:In body in room in crew quarters area 2 rec1
        ...
        ["placeaploc", "KeepDuplicates", [403, 405], 812, 1133], #812:In bodies on med bed 3 doors away from garden entrance 3 rec1
        ...
        ["randomizeenemy", "", 776, "5Ranged", vector(-151.27, -226.31, 18.85)],
    ...
    "rec2.mis": [
        ...
        ["placeaploc", "KeepDuplicates", [484], 821, 525], #821:In body in upper area in room with pool tables 2 rec2
        ["destroy", "RemoveDuplicates", 525],
        ["placeaploc", "", vector(-83.82, -139.26, -12.87), 822, 1329], #822:Behind wall that explodes in the dining area rec2
        ["placeaploc", "KeepDuplicates", vector(-83.82, -136.67, -12.87), 823, 1319], #823:Behind wall that explodes in the dining area 2 rec2
        ...
        ["placeaploc", "KeepDuplicates", [445, 459, 445], 826, 480], #826:In bodies in pits in lower part of garden area 2 rec2
        ...
        ["placeaploc", "KeepDuplicates", [1091, 419, 440, 1088, 1092], 829, 126], #829:In bodies in room with 5 bodies in lower area of garden 2 rec2
        ["destroy", "RemoveDuplicates", 126],
        ["placeaploc", "KeepDuplicates", [1091, 419, 440, 1088, 1092], 830, 996], #830:In bodies in room with 5 bodies in lower area of garden 3 rec2
        ["destroy", "RemoveDuplicates", 996],
        ...
        ["placeaploc", "KeepDuplicates", [1099, 1098, 1095], 834, 1946], #834:In bodies in keypadded room in lower garden area 2 rec2
        ["destroy", "RemoveDuplicates", 1946],
        ["placeaploc", "KeepDuplicates", [1099, 1098, 1095], 835, 139], #835:In bodies in keypadded room in lower garden area 3 rec2
        ["destroy", "RemoveDuplicates", 139],
        ["placeaploc", "KeepDuplicates", [1099, 1098, 1095], 836, 257], #836:In bodies in keypadded room in lower garden area 4 rec2
        ["destroy", "RemoveDuplicates", 257],
        ["placeaploc", "KeepDuplicates", [1099, 1098, 1095], 837, 773], #837:In bodies in keypadded room in lower garden area 5 rec2
        ...
        ["placeaploc", "KeepDuplicates", [1037, 1032, 2087, 413], 841, 258], #841:In crates in freezer area 2 rec2
        ...
        ["placeaploc", "KeepDuplicates", [1352, 593], 845, 777], #845:In bodies in lower area in room with ambush 2 rec2
        ["destroy", "RemoveDuplicates", 777],
        ["placeaploc", "KeepDuplicates", [1352, 593], 846, 615], #846:In bodies in lower area in room with ambush 3 rec2
        ...
        ["placeaploc", "KeepDuplicates", [110], 849, 1264], #849:In body behind bar in lounge 2 rec2
        ...
        ["placeaploc", "KeepDuplicates", [435], 855, 1441], #855:In body on upper floor of lounge 2 rec2
        ...
        ["placeaploc", "KeepDuplicates", [405], 858, 429], #858:In body in maintenance tunnel above dance floor 2 rec2
        ["destroy", "RemoveDuplicates", 429],
        ["placeaploc", "", [1914, 618], 859, 598], #859:In bodies in lower maintenance tunnels rec2
        ["placeaploc", "KeepDuplicates", [1914, 618], 860, 826], #860:In bodies in lower maintenance tunnels 2 rec2
        ["destroy", "RemoveDuplicates", 826],
        ["placeaploc", "KeepDuplicates", [1914, 618], 861, 1912], #861:In bodies in lower maintenance tunnels 3 rec2
        ["destroy", "RemoveDuplicates", 1912],
        ["placeaploc", "KeepDuplicates", [1914, 618], 862, 829], #862:In bodies in lower maintenance tunnels 4 rec2
        ...
        ["placeaploc", "KeepDuplicates", [1728], 864, 1732], #864:In desk near charger in room connected to maintenance tunnels 2 rec2
        ["destroy", "RemoveDuplicates", 1732],
        ["placeaploc", "", [1288], 865, 1984], #865:In body in hallway near security station rec2
        ["placeaploc", "KeepDuplicates", [1288], 866, 592], #866:In body in hallway near security station 2 rec2
        ["destroy", "RemoveDuplicates", 592],
        ["placeaploc", "KeepDuplicates", [1288], 867, 144], #867:In body in hallway near security station 3 rec2
        ...
        ["placeaploc", "KeepDuplicates", vector(72.2, -11.22, -29.62), 870, 661], #870:On ground in large area you drop into to get into lower maintenance tunnels 2 rec2
        ...
        ["destroy", "RemoveDuplicates", 485],
        ["placeaploc", "KeepDuplicates", [195, 199], 878, 200], #878:In security crates in chemical storage 3 rec2
        ["destroy", "RemoveDuplicates", 200],
        ["placeaploc", "KeepDuplicates", [195, 199], 879, 201], #879:In security crates in chemical storage 4 rec2
    ...
    "rec3.mis": [
        ...
        ["placeaploc", "KeepDuplicates", [271], 910, 445], #910:In body in theater 2 rec3
        ["destroy", "RemoveDuplicates", 445],
        ...
        ["placeaploc", "KeepDuplicates", vector(-251.46, -426.82, 17.58), 934, 326], #934:On pipes above at end of upper area near artechnology store 2 rec3
        ...
        ["placeaploc", "KeepDuplicates", [81], 942, 330], #942:In body in store with broken sign and half closed door 2 rec3
        ["destroy", "RemoveDuplicates", 330],
        ["placeaploc", "KeepDuplicates", [287], 943, 288], #943:In body near resurrection station in security station 2 rec3
    ...
    "command1.mis": [
        ...
        ["placeaploc", "KeepDuplicates", [1182], 954, 1183], #954:In body near resurrection station 2 command1
        ...
        ["placeaploc", "KeepDuplicates", [2243, 2375, 2201], 956, 2167], #956:In bodies near tram near replicators 2 command1
        ...
        ["placeaploc", "KeepDuplicates", [2243, 2375, 2201], 959, 1201], #959:In bodies near tram near replicators 3 command1
        ["destroy", "RemoveDuplicates", 1201],
        ...
        ["placeaploc", "KeepDuplicates", [2220, 209], 962, 1181], #962:In bodies near elevator 2 command1
        ["destroy", "RemoveDuplicates", 1181],
        ["placeaploc", "", vector(921.06, 111.23, -46), 963, 274], #963:On ground near crates near elevator command1
        ["placeaploc", "KeepDuplicates", [2220, 209], 964, 2224], #964:In bodies near elevator 3 command1
        ["destroy", "RemoveDuplicates", 2224],
        ["placeaploc", "KeepDuplicates", [2220, 209], 965, 2225], #965:In bodies near elevator 4 command1
        ["destroy", "RemoveDuplicates", 2225],
        ["placeaploc", "", [318], 966, 2221], #966:In security crate in upper area of cargo bay b command1
        ["placeaploc", "KeepDuplicates", [318], 967, 2196], #967:In security crate in upper area of cargo bay b 2 command1
        ["destroy", "RemoveDuplicates", 2196],
        ["placeaploc", "", [389], 968, 2197], #968:In body hidden in corner in upper area of cargo bay b command1
        ["placeaploc", "KeepDuplicates", [389], 969, 2195], #969:In body hidden in corner in upper area of cargo bay b 2 command1
        ["destroy", "RemoveDuplicates", 2195],
        ["placeaploc", "KeepDuplicates", [318], 970, 2226], #970:In security crate in upper area of cargo bay b 3 command1
        ["destroy", "RemoveDuplicates", 2226],
        ["placeaploc", "KeepDuplicates", [275], 971, 2194], #971:In body near shuttle command hallway entrance 2 command1
        ...
        ["placeaploc", "KeepDuplicates", [91], 976, 646], #976:In body in cargo bay a 2 command1
        ["destroy", "RemoveDuplicates", 646],
        ["placeaploc", "KeepDuplicates", [91], 977, 401], #977:In body in cargo bay a 3 command1
        ["destroy", "RemoveDuplicates", 401],
        ["placeaploc", "KeepDuplicates", [946, 2232], 978, 408], #978:In crates in cargo bay a 2 command1
        ...
        ["placeaploc", "KeepDuplicates", vector(761.8, 167.74, -6.87), 981, 107], #981:On ground in upper area of gargo bay b 2 command1
        ["destroy", "RemoveDuplicates", 107],
        ["placeaploc", "", [2240, 2236], 982, 2242], #982:In crates in cargo bay b command1
        ["placeaploc", "KeepDuplicates", [2240, 2236], 983, 184], #983:In crates in cargo bay b 2 command1
        ["destroy", "RemoveDuplicates", 184],
        ["placeaploc", "KeepDuplicates", [2240, 2236], 984, 2237], #984:In crates in cargo bay b 3 command1
        ["destroy", "RemoveDuplicates", 2237],
        ["placeaploc", "KeepDuplicates", [2240, 2236], 985, 2239], #985:In crates in cargo bay b 4 command1
        ...
        ["placeaploc", "KeepDuplicates", [2256], 989, 2230], #989:In body in room with forcefield blocking access to rickenbacker 2 command1
        ["destroy", "RemoveDuplicates", 2230],
        ["placeaploc", "KeepDuplicates", [2256], 990, 2231], #990:In body in room with forcefield blocking access to rickenbacker 3 command1
    ...
    "command2.mis": [
        ...
        ["placeaploc", "KeepDuplicates", vector(40.83, -139.28, -12.49), 1003, 2292], #1003:On ground in room in officers' area 2 command2
        ...
        ["placeaploc", "KeepDuplicates", [983], 1009, 2188], #1009:In body in path towards escape pods near fire 2 command2
        ...
        ["placeaploc", "KeepDuplicates", vector(6.87, -74.88, -35.92), 1011, 287], #1011:On ledge above steaming water near resurrection station 2 command2
        ["destroy", "RemoveDuplicates", 287],
        ["placeaploc", "KeepDuplicates", vector(-88.5, -166.49, -27.77), 1012, 187], #1012:On ground near escape pod that leaves 2 command2
        ["destroy", "RemoveDuplicates", 187],
        ["placeaploc", "KeepDuplicates", vector(-89.24, -170.11, -27.98), 1013, 135], #1013:On ground near escape pod that leaves 3 command2
        ...
        ["placeaploc", "KeepDuplicates", vector(-90.39, 29.68, -6.25), 1018, 2218], #1018:On counter in conference room near window smashed with bench 2 command2
        ...
        ["placeaploc", "KeepDuplicates", vector(-81.87, -41.42, -27.69), 1023, 1266], #1023:On ground near escape pod bay near beams 2 command2
        ...
        ["placeaploc", "KeepDuplicates", vector(-73.99, -50.32, -27.84), 1025, 415], #1025:On ground near escape pod bay near beams 3 command2
        ...
        ["placeaploc", "KeepDuplicates", [1565], 1027, 797], #1027:In locker in room near replicator near window smashed with bench 2 command2
        ...
        ["placeaploc", "KeepDuplicates", [183], 1032, 184], #1032:In body near resurrection station 2 command2
        ["destroy", "RemoveDuplicates", 184],
        ["placeaploc", "KeepDuplicates", [183], 1033, 1528], #1033:In body near resurrection station 3 command2
        ...
        ["placeaploc", "KeepDuplicates", [1489, 1501, 1505, 1485, 1481, 80, 1497, 1517, 1015, 1893, 1885, 1897, 1901, 1877, 1881, 1817, 1845, 1849, 1765, 1020, 1789, 1793, 1797, 1773, 1777], 1037, 2162], #1037:In lockers in rooms in officers' area 2 command2
        ["destroy", "RemoveDuplicates", 2162],
        ["placeaploc", "KeepDuplicates", [1489, 1501, 1505, 1485, 1481, 80, 1497, 1517, 1015, 1893, 1885, 1897, 1901, 1877, 1881, 1817, 1845, 1849, 1765, 1020, 1789, 1793, 1797, 1773, 1777], 1038, 2290], #1038:In lockers in rooms in officers' area 3 command2
        ["destroy", "RemoveDuplicates", 2290],
        ["placeaploc", "KeepDuplicates", [1489, 1501, 1505, 1485, 1481, 80, 1497, 1517, 1015, 1893, 1885, 1897, 1901, 1877, 1881, 1817, 1845, 1849, 1765, 1020, 1789, 1793, 1797, 1773, 1777], 1039, 2161], #1039:In lockers in rooms in officers' area 4 command2
        ["destroy", "RemoveDuplicates", 2161],
        ["placeaploc", "KeepDuplicates", [1489, 1501, 1505, 1485, 1481, 80, 1497, 1517, 1015, 1893, 1885, 1897, 1901, 1877, 1881, 1817, 1845, 1849, 1765, 1020, 1789, 1793, 1797, 1773, 1777], 1040, 2387], #1040:In lockers in rooms in officers' area 5 command2
        ["destroy", "RemoveDuplicates", 2387],
        ["placeaploc", "KeepDuplicates", [1489, 1501, 1505, 1485, 1481, 80, 1497, 1517, 1015, 1893, 1885, 1897, 1901, 1877, 1881, 1817, 1845, 1849, 1765, 1020, 1789, 1793, 1797, 1773, 1777], 1041, 651], #1041:In lockers in rooms in officers' area 6 command2
        ["destroy", "RemoveDuplicates", 651],
        ["placeaploc", "KeepDuplicates", [1489, 1501, 1505, 1485, 1481, 80, 1497, 1517, 1015, 1893, 1885, 1897, 1901, 1877, 1881, 1817, 1845, 1849, 1765, 1020, 1789, 1793, 1797, 1773, 1777], 1042, 2320], #1042:In lockers in rooms in officers' area 7 command2
        ["destroy", "RemoveDuplicates", 2320],
        ["placeaploc", "KeepDuplicates", [1489, 1501, 1505, 1485, 1481, 80, 1497, 1517, 1015, 1893, 1885, 1897, 1901, 1877, 1881, 1817, 1845, 1849, 1765, 1020, 1789, 1793, 1797, 1773, 1777], 1043, 2216], #1043:In lockers in rooms in officers' area 8 command2
        ["destroy", "RemoveDuplicates", 2216],
        ["placeaploc", "KeepDuplicates", [1489, 1501, 1505, 1485, 1481, 80, 1497, 1517, 1015, 1893, 1885, 1897, 1901, 1877, 1881, 1817, 1845, 1849, 1765, 1020, 1789, 1793, 1797, 1773, 1777], 1044, 293], #1044:In lockers in rooms in officers' area 9 command2
        ["destroy", "RemoveDuplicates", 293],
        ["placeaploc", "KeepDuplicates", [1489, 1501, 1505, 1485, 1481, 80, 1497, 1517, 1015, 1893, 1885, 1897, 1901, 1877, 1881, 1817, 1845, 1849, 1765, 1020, 1789, 1793, 1797, 1773, 1777], 1045, 2288], #1045:In lockers in rooms in officers' area 10 command2
        ["destroy", "RemoveDuplicates", 2288],
        ["placeaploc", "KeepDuplicates", [1489, 1501, 1505, 1485, 1481, 80, 1497, 1517, 1015, 1893, 1885, 1897, 1901, 1877, 1881, 1817, 1845, 1849, 1765, 1020, 1789, 1793, 1797, 1773, 1777], 1046, 547], #1046:In lockers in rooms in officers' area 11 command2
        ...
        ["placeaploc", "KeepDuplicates", [1424], 1052, 2277], #1052:In security crate in area under officers' quarters 2 command2
        ["destroy", "RemoveDuplicates", 2277],
        ["placeaploc", "KeepDuplicates", [1424], 1053, 2276], #1053:In security crate in area under officers' quarters 3 command2
        ...
        ["placeaploc", "KeepDuplicates", [1675], 1058, 2286], #1058:In locker in room with muerte written on wall in officers' quarters 2 command2
        ["destroy", "RemoveDuplicates", 2286],
        ["placeaploc", "KeepDuplicates", [1675], 1059, 2287], #1059:In locker in room with muerte written on wall in officers' quarters 3 command2
        ...
        ["placeaploc", "KeepDuplicates", [532], 1062, 148], #1062:In desk in security room in officers' area 2 command2
        ["destroy", "RemoveDuplicates", 148],
        ["placeaploc", "", [84], 1063, 2385], #1063:In body in path towards officers' area command2
        ["placeaploc", "KeepDuplicates", [84], 1064, 1399], #1064:In body in path towards officers' area 2 command2
        ...
        ["placeaploc", "KeepDuplicates", [1427], 1067, 2165], #1067:In high-security crate 2 command2
        ["destroy", "RemoveDuplicates", 2165],
        ["placeaploc", "KeepDuplicates", [1427], 1068, 1430], #1068:In high-security crate 3 command2
        ["destroy", "RemoveDuplicates", 1430],
        ["placeaploc", "KeepDuplicates", [1427], 1069, 1431], #1069:In high-security crate 4 command2
        ["destroy", "RemoveDuplicates", 1431],
        ["placeaploc", "KeepDuplicates", [1427], 1070, 1432], #1070:In high-security crate 5 command2
        ["destroy", "RemoveDuplicates", 1432],
        ["placeaploc", "KeepDuplicates", [1427], 1071, 1433], #1071:In high-security crate 6 command2
        ["destroy", "RemoveDuplicates", 1433],
        ["placeaploc", "", [1335], 1072, 1334], #1072:In crate in area under officers' quarters command2
        ["placeaploc", "KeepDuplicates", [1356], 1073, 1422], #1073:In body in room in officers' quarters 2 command2
        ...
        ["placeaploc", "KeepDuplicates", vector(138.46, 2.28, 32.21), 1094, 1583], #1094:On desk near large window in bridge area 2 command2
        ...
        ["placeaploc", "KeepDuplicates", [268, 261], 1097, 2209], #1097:In bodies in upper area of bridge 2 command2
        ...
        ["placeaploc", "KeepDuplicates", vector(35.96, 3.3, 48.06), 1101, 2214], #1101:On conference table in upper area of bridge 2 command2
        ...
        ["placeaploc", "KeepDuplicates", [1426], 1105, 2210], #1105:In high-security crate in room that opens after rickenbacker forcefield appears in upper area of bridge 2 command2
        ["destroy", "RemoveDuplicates", 2210],
        ["placeaploc", "KeepDuplicates", [1426], 1106, 1429], #1106:In high-security crate in room that opens after rickenbacker forcefield appears in upper area of bridge 3 command2
        ...
        ["placeaploc", "KeepDuplicates", [595], 1109, 1262], #1109:In body in water in lobby near entrance 2 command2
        ...
        ["placeaploc", "KeepDuplicates", [2124], 1115, 2181], #1115:In body near table in path towards officers' area 2 command2
        ["destroy", "RemoveDuplicates", 2181],
        ["placeaploc", "KeepDuplicates", [2124], 1116, 2189], #1116:In body near table in path towards officers' area 3 command2
        ["destroy", "RemoveDuplicates", 2189],
        ["placeaploc", "KeepDuplicates", [1419], 1117, 2180], #1117:In body in room under resurrection station 2 command2
    ...
    "rick1.mis": [
        ...
        ["placeaploc", "KeepDuplicates", [2157], 1123, 2158], #1123:In high-security crate near resurrection station 2 rick1
        ["destroy", "RemoveDuplicates", 2158],
        ["placeaploc", "KeepDuplicates", [2157], 1124, 2159], #1124:In high-security crate near resurrection station 3 rick1
        ["destroy", "RemoveDuplicates", 2159],
        ["placeaploc", "KeepDuplicates", [2157], 1125, 2160], #1125:In high-security crate near resurrection station 4 rick1
        ...
        ["placeaploc", "KeepDuplicates", [1458], 1131, 1460], #1131:In body near entrance 2 rick1
        ["destroy", "RemoveDuplicates", 1460],
        ["placeaploc", "KeepDuplicates", [1458], 1132, 1402], #1132:In body near entrance 3 rick1
        ...
        ["placeaploc", "KeepDuplicates", vector(-161.43, -82.55, 96.2), 1138, 2130], #1138:On ground near egg in dead end room near chemical storage 2 rick1
        ["destroy", "RemoveDuplicates", 2130],
        ["placeaploc", "KeepDuplicates", vector(-162.01, -80.72, 96.1), 1139, 1785], #1139:On ground near egg in dead end room near chemical storage 3 rick1
        ...
        ["placeaploc", "KeepDuplicates", [2164], 1142, 2166], #1142:In security crate near ramp downward near bridge that extends 2 rick1
        ...
        ["placeaploc", "KeepDuplicates", [2181], 1145, 2183], #1145:In security crate along path to pod 2 in area before radiated area 2 rick1
        ["destroy", "RemoveDuplicates", 2183],
        ["placeaploc", "KeepDuplicates", [2181], 1146, 2184], #1146:In security crate along path to pod 2 in area before radiated area 3 rick1
        ["destroy", "RemoveDuplicates", 2184],
        ["placeaploc", "KeepDuplicates", [2181], 1147, 2185], #1147:In security crate along path to pod 2 in area before radiated area 4 rick1
        ["destroy", "RemoveDuplicates", 2185],
        ["placeaploc", "KeepDuplicates", [2181], 1148, 2112], #1148:In security crate along path to pod 2 in area before radiated area 5 rick1
        ["destroy", "RemoveDuplicates", 2112],
        ["placeaploc", "KeepDuplicates", [2181], 1149, 2111], #1149:In security crate along path to pod 2 in area before radiated area 6 rick1
        ...
        ["placeaploc", "KeepDuplicates", [2211], 1152, 2213], #1152:In security crate near pod2 exit 2 rick1
        ["destroy", "RemoveDuplicates", 2213],
        ["placeaploc", "KeepDuplicates", [2211], 1153, 2214], #1153:In security crate near pod2 exit 3 rick1
        ["destroy", "RemoveDuplicates", 2214],
        ["placeaploc", "KeepDuplicates", [2211], 1154, 2212], #1154:In security crate near pod2 exit 4 rick1
        ["destroy", "RemoveDuplicates", 2212],
        ["placeaploc", "", [1636], 1155, 1770], #1155:In body across bridge that extends rick1
        ["placeaploc", "KeepDuplicates", [1636], 1156, 1773], #1156:In body across bridge that extends 2 rick1
        ["destroy", "RemoveDuplicates", 1773],
        ["placeaploc", "KeepDuplicates", [1636], 1157, 1776], #1157:In body across bridge that extends 3 rick1
        ["destroy", "RemoveDuplicates", 1776],
        ["placeaploc", "KeepDuplicates", [1636], 1158, 1779], #1158:In body across bridge that extends 4 rick1
        ...
        ["placeaploc", "KeepDuplicates", [1786], 1162, 1788], #1162:In body on path to pod 2 at start of the path 2 rick1
        ["destroy", "RemoveDuplicates", 1788],
        ["placeaploc", "KeepDuplicates", vector(-274.36, 32.25, 181.08), 1163, 1365], #1163:Hidden in room behind glass near ladder near end of path to pod 2 rick1
        ["destroy", "RemoveDuplicates", 1365],
        ["placeaploc", "KeepDuplicates", vector(-285.95, 14.16, 204.13), 1164, 907], #1164:Hidden behind pipes near end of path 2 rick1
        ["destroy", "RemoveDuplicates", 907],
        ["placeaploc", "KeepDuplicates", vector(-270.75, -14.41, 200.33), 1165, 1039], #1165:On ground near body near end of path 2 rick1
        ["destroy", "RemoveDuplicates", 1039],
        ["placeaploc", "", vector(-242.23, 5.21, 96.18), 1166, 1727], #1166:Hidden behind pipes on path to pod2 rick1
        ["placeaploc", "KeepDuplicates", vector(-252.22, -51.04, 88.08), 1167, 1801], #1167:On ground at bottom of ladder on path to pod 2 rick1
        ["destroy", "RemoveDuplicates", 1801],
        ["placeaploc", "KeepDuplicates", [1800], 1168, 1802], #1168:In body on path to pod 2 rick1
        ["destroy", "RemoveDuplicates", 1802],
        ["placeaploc", "KeepDuplicates", vector(-237.74, -28.91, 102.05), 1169, 2120], #1169:On table on path to pod 2 rick1
        ...
        ["placeaploc", "KeepDuplicates", vector(-194.16, -41.25, 92.11), 1175, 1787], #1175:On ground near body on path to pod 2 rick1
        ["destroy", "RemoveDuplicates", 1787],
        ["placeaploc", "", [2178], 1176, 2177], #1176:In crate near first button that extends bridge rick1
        ["placeaploc", "KeepDuplicates", [2178], 1177, 2179], #1177:In crate near first button that extends bridge 2 rick1
        ...
        ["placeaploc", "KeepDuplicates", [1761], 1182, 1768], #1182:In body near first button that extends bridge 2 rick1
        ["destroy", "RemoveDuplicates", 1768],
        ["placeaploc", "KeepDuplicates", [1761], 1183, 1767], #1183:In body near first button that extends bridge 3 rick1
        ...
        ["placeaploc", "KeepDuplicates", [1623, 1413, 342], 1195, 1797], #1195:In bodies at top of dual broken ladders that you jump between 2 rick1
        ...
        ["placeaploc", "KeepDuplicates", [1621, 1619], 1197, 494], #1197:In bodies at bottom of dual broken ladders that you jump between 2 rick1
        ["destroy", "RemoveDuplicates", 494],
        ["placeaploc", "KeepDuplicates", [1623, 1413, 342], 1198, 1414], #1198:In bodies at top of dual broken ladders that you jump between 3 rick1
        ["destroy", "RemoveDuplicates", 1414],
        ["placeaploc", "", vector(-112.19, 17.83, 88.14), 1199, 914], #1199:On ground near pipes in nacelle a rick1
        ["placeaploc", "KeepDuplicates", vector(-116.37, 8.51, 88.08), 1200, 471], #1200:On ground near pipes in nacelle a 2 rick1
        ...
        ["placeaploc", "KeepDuplicates", [360, 2162, 2154], 1204, 2097], #1204:In body bags in nacelle a 2 rick1
        ...
        ["placeaploc", "KeepDuplicates", [1567], 1206, 1467], #1206:In body in room with button that raises barrier near top of ladder near entrance 2 rick1
        ["destroy", "RemoveDuplicates", 1467],
        ["placeaploc", "KeepDuplicates", [1567], 1207, 1404], #1207:In body in room with button that raises barrier near top of ladder near entrance 3 rick1
        ...
        ["placeaploc", "KeepDuplicates", vector(-131.26, -5.61, 101.17), 1214, 1313], #1214:In chemical storage room 6 rick1
        ...
        ["placeaploc", "KeepDuplicates", vector(-127.51, -6.2, 101.44), 1216, 1312], #1216:In chemical storage room 8 rick1
    ...
    "rick2.mis": [
        ...
        ["placeaploc", "KeepDuplicates", [144], 1245, 147], #1245:In body near pipe jump 2 rick2
        ...
        ["placeaploc", "KeepDuplicates", vector(-350.9, -14.43, 221.25), 1250, 116], #1250:On ground near body near entrance 2 rick2
        ["destroy", "RemoveDuplicates", 116],
        ...
        ["placeaploc", "KeepDuplicates", vector(-422.05, 20.74, 196.08), 1253, 246], #1253:On ground at bottom of pipe jump 2 rick2
        ["destroy", "RemoveDuplicates", 246],
        ["placeaploc", "", [704, 149], 1254, 150], #1254:In bodies in church rick2
        ["placeaploc", "KeepDuplicates", [704, 149], 1255, 151], #1255:In bodies in church 2 rick2
        ["destroy", "RemoveDuplicates", 151],
        ["placeaploc", "KeepDuplicates", [704, 149], 1256, 152], #1256:In bodies in church 3 rick2
        ["destroy", "RemoveDuplicates", 152],
        ["placeaploc", "KeepDuplicates", [704, 149], 1257, 746], #1257:In bodies in church 4 rick2
        ["destroy", "RemoveDuplicates", 746],
        ["placeaploc", "KeepDuplicates", [704, 149], 1258, 702], #1258:In bodies in church 5 rick2
        ["destroy", "RemoveDuplicates", 702],
        ["placeaploc", "KeepDuplicates", vector(-448.78, -7.29, 207.08), 1259, 117], #1259:On ground near body in church 2 rick2
        ...
        ["placeaploc", "KeepDuplicates", vector(-508.43, 31.44, 287.52), 1263, 153], #1263:On ground near body nearish exit 2 rick2
        ["destroy", "RemoveDuplicates", 153],
        ["placeaploc", "", [155, 85], 1264, 156], #1264:In bodies nearish exit rick2
        ["placeaploc", "KeepDuplicates", [155, 85], 1265, 724], #1265:In bodies nearish exit 2 rick2
        ["destroy", "RemoveDuplicates", 724],
        ["placeaploc", "KeepDuplicates", vector(-498.24, -1.32, 288.08), 1266, 336], #1266:On ground near body nearish exit 3 rick2
        ["destroy", "RemoveDuplicates", 336],
        ["placeaploc", "KeepDuplicates", vector(-503.44, -3.12, 288.1), 1267, 158], #1267:On ground near body nearish exit 4 rick2
        ["destroy", "RemoveDuplicates", 158],
        ["placeaploc", "KeepDuplicates", [155, 85], 1268, 774], #1268:In bodies nearish exit 3 rick2
        ["destroy", "RemoveDuplicates", 774],
        ["placeaploc", "", vector(-504.22, -36.87, 287.14), 1269, 160], #1269:On ground near exit rick2
        ["placeaploc", "KeepDuplicates", vector(-499.76, -37.89, 287.45), 1270, 164], #1270:On ground near exit 2 rick2
    ...
    "rick3.mis": [
        ...
        ["placeaploc", "KeepDuplicates", [506], 1281, 508], #1281:In body on path to escape pod 2 rick3
        ["destroy", "RemoveDuplicates", 508],
        ["placeaploc", "KeepDuplicates", [506], 1282, 509], #1282:In body on path to escape pod 3 rick3
        ["destroy", "RemoveDuplicates", 509],
        ["placeaploc", "", [501], 1283, 503], #1283:In body behind keycarded door near entrance rick3
        ["placeaploc", "KeepDuplicates", [501], 1284, 505], #1284:In body behind keycarded door near entrance 2 rick3
        ["destroy", "RemoveDuplicates", 505],
        ["placeaploc", "KeepDuplicates", [501], 1285, 502], #1285:In body behind keycarded door near entrance 3 rick3
        ["destroy", "RemoveDuplicates", 502],
        ["placeaploc", "", vector(-678.93, -53.67, 276.79), 1286, 788], #1286:On shelves near replicator rick3
        ["placeaploc", "KeepDuplicates", vector(-678.93, -52.17, 276.79), 1287, 789], #1287:On shelves near replicator 2 rick3
        ["destroy", "RemoveDuplicates", 789],
        ["placeaploc", "KeepDuplicates", vector(-679.12, -50.36, 279.14), 1288, 500], #1288:On shelves near replicator 3 rick3
        ["destroy", "RemoveDuplicates", 500],
        ["placeaploc", "KeepDuplicates", vector(-678.87, -49.11, 276.64), 1289, 496], #1289:On shelves near replicator 4 rick3
        ["destroy", "RemoveDuplicates", 496],
        ["placeaploc", "KeepDuplicates", vector(-678.62, -45.86, 276.65), 1290, 498], #1290:On shelves near replicator 5 rick3
    ...
    "many.mis": [
        ...
        ["placeaploc", "KeepDuplicates", [135, 768], 1295, 138], #1295:In bodies in water near nerve cluster 2 many
        ...
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1300, 293], #1300:In bodies on path with 4 rooms that have bodies in them 2 many
        ["destroy", "RemoveDuplicates", 293],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1301, 292], #1301:In bodies on path with 4 rooms that have bodies in them 3 many
        ["destroy", "RemoveDuplicates", 292],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1302, 388], #1302:In bodies on path with 4 rooms that have bodies in them 4 many
        ["destroy", "RemoveDuplicates", 388],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1303, 888], #1303:In bodies on path with 4 rooms that have bodies in them 5 many
        ["destroy", "RemoveDuplicates", 888],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1304, 302], #1304:In bodies on path with 4 rooms that have bodies in them 6 many
        ["destroy", "RemoveDuplicates", 302],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1305, 291], #1305:In bodies on path with 4 rooms that have bodies in them 7 many
        ["destroy", "RemoveDuplicates", 291],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1306, 745], #1306:In bodies on path with 4 rooms that have bodies in them 8 many
        ["destroy", "RemoveDuplicates", 745],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1307, 233], #1307:In bodies on path with 4 rooms that have bodies in them 9 many
        ["destroy", "RemoveDuplicates", 233],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1308, 773], #1308:In bodies on path with 4 rooms that have bodies in them 10 many
        ["destroy", "RemoveDuplicates", 773],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1309, 296], #1309:In bodies on path with 4 rooms that have bodies in them 11 many
        ["destroy", "RemoveDuplicates", 296],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1310, 298], #1310:In bodies on path with 4 rooms that have bodies in them 12 many
        ["destroy", "RemoveDuplicates", 298],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1311, 1431], #1311:In bodies on path with 4 rooms that have bodies in them 13 many
        ["destroy", "RemoveDuplicates", 1431],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1312, 985], #1312:In bodies on path with 4 rooms that have bodies in them 14 many
        ["destroy", "RemoveDuplicates", 985],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1313, 295], #1313:In bodies on path with 4 rooms that have bodies in them 15 many
        ["destroy", "RemoveDuplicates", 295],
        ["placeaploc", "KeepDuplicates", [226, 887, 214, 210, 1429, 770, 209, 1430, 958], 1314, 297], #1314:In bodies on path with 4 rooms that have bodies in them 16 many
        ...
        ["placeaploc", "KeepDuplicates", vector(-227.51, 348.01, 50.59), 1316, 1389], #1316:On ground near bodies on path with 4 rooms that have bodies in them 2 many
        ...
        ["placeaploc", "KeepDuplicates", [35, 45], 1320, 38], #1320:In bodies in rickenbacker room connected to hub connected to path with 4 rooms that have bodies in them 2 many
        ["destroy", "RemoveDuplicates", 38],
        ["placeaploc", "KeepDuplicates", [35, 45], 1321, 53], #1321:In bodies in rickenbacker room connected to hub connected to path with 4 rooms that have bodies in them 3 many
        ["destroy", "RemoveDuplicates", 53],
        ["placeaploc", "KeepDuplicates", [35, 45], 1322, 63], #1322:In bodies in rickenbacker room connected to hub connected to path with 4 rooms that have bodies in them 4 many
        ["destroy", "RemoveDuplicates", 63],
        ["placeaploc", "KeepDuplicates", [35, 45], 1323, 684], #1323:In bodies in rickenbacker room connected to hub connected to path with 4 rooms that have bodies in them 5 many
        ...
        ["placeaploc", "KeepDuplicates", vector(-553.88, 455.81, -1.2), 1325, 775], #1325:On ground near body in area after you jump in water 2 many
        ["destroy", "RemoveDuplicates", 775],
        ["placeaploc", "KeepDuplicates", vector(-557.15, 458.56, -1.89), 1326, 330], #1326:On ground near body in area after you jump in water 3 many
        ["destroy", "RemoveDuplicates", 330],
        ["placeaploc", "", [747], 1327, 1421], #1327:In body in water you jump into many
        ["placeaploc", "KeepDuplicates", [135, 768], 1328, 769], #1328:In bodies in water near nerve cluster 3 many
        ["destroy", "RemoveDuplicates", 769],
        ["placeaploc", "", [916], 1329, 100], #1329:In body in water under nerve cluster many
        ["placeaploc", "KeepDuplicates", [916], 1330, 959], #1330:In body in water under nerve cluster 2 many
        ...
        ["placeaploc", "KeepDuplicates", [279], 1334, 281], #1334:In body in air pocket above large chamber of water on path to nerve cluster area 2 many
        ["destroy", "RemoveDuplicates", 281],
        ["placeaploc", "KeepDuplicates", [279], 1335, 306], #1335:In body in air pocket above large chamber of water on path to nerve cluster area 3 many
        ["destroy", "RemoveDuplicates", 306],
        ["placeaploc", "KeepDuplicates", [275, 276], 1336, 277], #1336:In bodies in large chamber of water on path to nerve cluster 2 many
        ...
        ["placeaploc", "KeepDuplicates", [78], 1340, 99], #1340:In body near start of level 2 many
        ...
        ["placeaploc", "KeepDuplicates", [839, 552], 1343, 960], #1343:In bodies near first replicator 2 many
        ["destroy", "RemoveDuplicates", 960],
        ["placeaploc", "KeepDuplicates", [839, 552], 1344, 884], #1344:In bodies near first replicator 3 many
        ["destroy", "RemoveDuplicates", 884],
        ["placeaploc", "KeepDuplicates", [839, 552], 1345, 52], #1345:In bodies near first replicator 4 many
        ...
        ["placeaploc", "KeepDuplicates", [1414], 1351, 1416], #1351:In security crate near first replicator 2 many
        ["destroy", "RemoveDuplicates", 1416],
        ["placeaploc", "KeepDuplicates", [1414], 1352, 1415], #1352:In security crate near first replicator 3 many
        ...
        ["placeaploc", "KeepDuplicates", [80], 1355, 96], #1355:In body nearish start of level 2 many
        ["destroy", "RemoveDuplicates", 96],
        ["placeaploc", "", vector(31.49, -115.64, -1.53), 1356, 757], #1356:On ground near start of body nearish start of level many
        ["placeaploc", "KeepDuplicates", vector(16.93, -150.43, 2.83), 1357, 329], #1357:On ground near start of level 2 many
        ...
        ["placeaploc", "KeepDuplicates", vector(-11.76, -114.38, -6.85), 1361, 244], #1361:On ground in piece of rickenbacker near start of level 4 many
        ...
        ["placeaploc", "KeepDuplicates", [245], 1364, 257], #1364:In body in piece of rickenbacker near start of level 2 many
        ["destroy", "RemoveDuplicates", 257],
        ["placeaploc", "", [140], 1365, 122], #1365:In desk in water on path to first nerve cluster many
        ["placeaploc", "KeepDuplicates", [140], 1366, 123], #1366:In desk in water on path to first nerve cluster 2 many
        ["destroy", "RemoveDuplicates", 123],
        ["placeaploc", "", [686], 1367, 120], #1367:In body in water on path to first nerve cluster many
        ["placeaploc", "KeepDuplicates", [686], 1368, 687], #1368:In body in water on path to first nerve cluster 2 many
        ["destroy", "RemoveDuplicates", 687],
        ["placeaploc", "KeepDuplicates", [686], 1369, 116], #1369:In body in water on path to first nerve cluster 3 many
        ["destroy", "RemoveDuplicates", 116],
        ...
        ["placeaploc", "KeepDuplicates", [305], 1372, 304], #1372:In body under broken doors near chemical storage 2 many
        ["destroy", "RemoveDuplicates", 304],
        ["placeaploc", "", [919], 1373, 1347], #1373:In body near chemical storage many
        ["placeaploc", "KeepDuplicates", [919], 1374, 920], #1374:In body near chemical storage 2 many
        ...
        ["placeaploc", "KeepDuplicates", [328], 1377, 386], #1377:In body near first nerve cluster door 2 many
        ["destroy", "RemoveDuplicates", 386],
        ["placeaploc", "", vector(-126.65, 104.85, 26.78), 1378, 310], #1378:Under broken doors after first nerve cluster door many
        ["placeaploc", "KeepDuplicates", vector(-121.05, 108.44, 26.57), 1379, 982], #1379:Under broken doors after first nerve cluster door 2 many
        ["destroy", "RemoveDuplicates", 982],
        ["placeaploc", "KeepDuplicates", vector(-121.38, 110.09, 26.55), 1380, 311], #1380:Under broken doors after first nerve cluster door 3 many
        ...
        ["placeaploc", "KeepDuplicates", [331], 1385, 1348], #1385:In body near first chamber after nerve cluster is destroyed 2 many
        ...
        ["placeaploc", "KeepDuplicates", vector(-96.45, 118.99, 47.04), 1387, 1465], #1387:Above mouth after first nerve cluster door 2 many
        ...
        ["placeaploc", "KeepDuplicates", [885], 1389, 1428], #1389:In body in small tunnel near tooth room before second nerve cluster door 2 many
        ["destroy", "RemoveDuplicates", 1428],
        ["placeaploc", "", [263], 1390, 264], #1390:In body after second nerve cluster door many
        ["placeaploc", "KeepDuplicates", [263], 1391, 265], #1391:In body after second nerve cluster door 2 many
        ...
        ["placeaploc", "KeepDuplicates", [1485], 1393, 1587], #1393:In body hidden above in hub room connected to path with 4 rooms that have bodies in them 2 many
        ["destroy", "RemoveDuplicates", 1587],
        ["placeaploc", "", [283], 1394, 387], #1394:In body in hub room connected to path with 4 rooms that have bodies in them many
        ["placeaploc", "KeepDuplicates", [283], 1395, 284], #1395:In body in hub room connected to path with 4 rooms that have bodies in them 2 many
        ...
        ["placeaploc", "KeepDuplicates", [921], 1398, 1432], #1398:In waste barrel in rickenbacker room connected to hub connected to path with 4 rooms that have bodies in them 2 many
        ["destroy", "RemoveDuplicates", 1432],
        ...
        ["placeaploc", "KeepDuplicates", [69, 47, 71, 746], 1400, 49], #1400:In crates or desk in rickenbacker room connected to hub connected to path with 4 rooms that have bodies in them 2 many
        ["destroy", "RemoveDuplicates", 49],
        ["placeaploc", "KeepDuplicates", [69, 47, 71, 746], 1401, 57], #1401:In crates or desk in rickenbacker room connected to hub connected to path with 4 rooms that have bodies in them 3 many
        ["destroy", "RemoveDuplicates", 57],
        ["placeaploc", "KeepDuplicates", [69, 47, 71, 746], 1402, 766], #1402:In crates or desk in rickenbacker room connected to hub connected to path with 4 rooms that have bodies in them 4 many
        ["destroy", "RemoveDuplicates", 766],
        ["placeaploc", "KeepDuplicates", [69, 47, 71, 746], 1403, 779], #1403:In crates or desk in rickenbacker room connected to hub connected to path with 4 rooms that have bodies in them 5 many
        ...
        ["placeaploc", "KeepDuplicates", [299], 1406, 300], #1406:In body in room before jump into water 2 many
        ...
        ["placeaploc", "KeepDuplicates", [392, 389, 747], 1409, 72], #1409:In bodies in water you jump into 2 many
        ["destroy", "RemoveDuplicates", 72],
        ["placeaploc", "KeepDuplicates", [392, 389, 747], 1410, 137], #1410:In bodies in water you jump into 3 many
        ["destroy", "RemoveDuplicates", 137],
        ["placeaploc", "KeepDuplicates", [392, 389, 747], 1411, 391], #1411:In bodies in water you jump into 4 many
        ["destroy", "RemoveDuplicates", 391],
        ["placeaploc", "", [946], 1412, 945], #1412:In body hidden above jump geyser after jump into water many
        ["placeaploc", "KeepDuplicates", [946], 1413, 947], #1413:In body hidden above jump geyser after jump into water 2 many
        ["destroy", "RemoveDuplicates", 947],
        ["placeaploc", "", [688], 1414, 690], #1414:In body afer jump into water many
        ["placeaploc", "KeepDuplicates", [688], 1415, 689], #1415:In body afer jump into water 2 many
        ["destroy", "RemoveDuplicates", 689],
        ["placeaploc", "", [234, 169, 287], 1416, 685], #1416:In bodies in chemical storeroom many
        ["placeaploc", "KeepDuplicates", [234, 169, 287], 1417, 266], #1417:In bodies in chemical storeroom 2 many
        ["destroy", "RemoveDuplicates", 266],
        ["placeaploc", "KeepDuplicates", [234, 169, 287], 1418, 170], #1418:In bodies in chemical storeroom 3 many
        ["destroy", "RemoveDuplicates", 170],
        ["placeaploc", "KeepDuplicates", [234, 169, 287], 1419, 172], #1419:In bodies in chemical storeroom 4 many
        ["destroy", "RemoveDuplicates", 172],
        ["placeaploc", "KeepDuplicates", [234, 169, 287], 1420, 288], #1420:In bodies in chemical storeroom 5 many
        ["destroy", "RemoveDuplicates", 288],
        ["placeaploc", "KeepDuplicates", [234, 169, 287], 1421, 961], #1421:In bodies in chemical storeroom 6 many
        ["destroy", "RemoveDuplicates", 961],
        ["placeaploc", "", [1423], 1422, 1424], #1422:In security crate in chemical storage many
        ["placeaploc", "KeepDuplicates", [1423], 1423, 70], #1423:In security crate in chemical storage 2 many
    ...
    "shodan.mis": [
        ...
        ["placeaploc", "KeepDuplicates", vector(-78, 22, 64.32), 1457, 1230], #1457:In supply cache at top of block stairs near shodan teleport 2 shodan
        ["destroy", "RemoveDuplicates", 1230],
        ["placeaploc", "KeepDuplicates", vector(-77, 22, 64.19), 1458, 1231], #1458:In supply cache at top of block stairs near shodan teleport 3 shodan
        ["destroy", "RemoveDuplicates", 1231],
        ["placeaploc", "KeepDuplicates", vector(-79.5, 22, 64.26), 1459, 1232], #1459:In supply cache at top of block stairs near shodan teleport 4 shodan
        ["destroy", "RemoveDuplicates", 1232],
        ["placeaploc", "KeepDuplicates", vector(-77, 24, 64.23), 1460, 1233], #1460:In supply cache at top of block stairs near shodan teleport 5 shodan
        ["destroy", "RemoveDuplicates", 1233],
        ["placeaploc", "KeepDuplicates", vector(-81, 22, 64.29), 1461, 1338], #1461:In supply cache at top of block stairs near shodan teleport 6 shodan
        ["destroy", "RemoveDuplicates", 1338],
        ["placeaploc", "KeepDuplicates", vector(-80, 24, 64.29), 1462, 1339], #1462:In supply cache at top of block stairs near shodan teleport 7 shodan
        ["destroy", "RemoveDuplicates", 1339],
        ["placeaploc", "KeepDuplicates", vector(-79, 24, 64.29), 1463, 1337], #1463:In supply cache at top of block stairs near shodan teleport 8 shodan
        ["destroy", "RemoveDuplicates", 1337],
        ["placeaploc", "KeepDuplicates", vector(-78, 24, 64.42), 1464, 1336], #1464:In supply cache at top of block stairs near shodan teleport 9 shodan
        ...
        ["placeaploc", "KeepDuplicates", [1253, 1254, 1255, 1256], 1479, 1258], #1479:In crates near camera 2 shodan
        ["destroy", "RemoveDuplicates", 1258],
        ["placeaploc", "KeepDuplicates", [1253, 1254, 1255, 1256], 1480, 1257], #1480:In crates near camera 3 shodan
